...
module.exports.run = async (client, message, args) => {
 ...
 » **!!alevlogo** : Alevli Logo Oluşturur.

 » **!!altınlogo** : Altın Şeklinde Logo Oluşturur.

 » **!!arrowlogo** : Arrow Şeklinde Logo Oluşturur.

 » **!!basitlogo** : Basit Logo Oluşturur.

 » **!!dinamiklogo** : Dinamik Logo Oluşturur.

 » **!!gamerlogo** : Gamer Logo Oluşturur.

 » **!!greenlogo** : Green Logo Oluşturur.

 » **!!kırmızılogo** : Kırmızı Logo Oluşturur.`)
    ...
    .setTitle(`Star Bot | Logo Menüsü`, message.author.avatarURL)
